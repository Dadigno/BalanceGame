...
namespace BalanceGame
{
    ...
    "mputer Interaction course";
        ...
        public static string finish_game_message = "Great!\nYou found the weight!";
        public static string finish_game_caption = "Game Over";
        public static string finish_game_nomoves = "Oh no!\nThere are no moves left!";
